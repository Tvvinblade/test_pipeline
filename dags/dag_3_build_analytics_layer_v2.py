"""
DAG 3: Построение Analytics Layer - ФИНАЛЬНАЯ РАБОЧАЯ ВЕРСИЯ
- user_activity: объединение browser_events + device_events + geo_events + location_events
- traffic_source_metrics: utm источники с device и geo обогащением
- funnel_analysis: funnel steps с правильным step_order
"""
...
def build_analytics(**context):
    ...
    try:
        ...
        logger.info(f"✅ user_activity: {count} rows")
        ...
        logger.info(f"✅ traffic_source_metrics: {count} rows")
        ...
        logger.info(f"✅ funnel_analysis: {count} rows")
